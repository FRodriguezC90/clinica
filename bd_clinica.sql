...
CREATE TABLE `agendas` (
  ...
  `Agend_especialista` varchar(45) DEFAULT NULL,
  `Agend_paciente` varchar(45) DEFAULT NULL,
  `Agend_fecha` varchar(45) DEFAULT NULL,
  `Agend_hora` varchar(45) DEFAULT NULL,
...
CREATE TABLE `especialidades` (
  ...
  `Espec_nombre` varchar(45) DEFAULT NULL,
...
INSERT INTO `especialidades` VALUES (1,'Traumatologia'),(2,'Oftalmologia'),(3,'Cardiologia'),(4,'Oncologia'),(5,'Neurologia');
...
CREATE TABLE `medicos` (
  ...
  `Medicos_usuario` varchar(45) DEFAULT NULL,
  `Medicos_clave` varchar(45) DEFAULT NULL,
...
INSERT INTO `medicos` VALUES (1,'1drtrauma','trauma123'),(2,'1droftal','oftal123'),(3,'1drcardio','cardio123'),(4,'1dronco','onco123'),(5,'1drneuro','neuro123');
...
CREATE TABLE `pacientes` (
  `Pac_id` int NOT NULL,
  `Pac_usuario` varchar(45) DEFAULT NULL,
  `Pac_clave` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Pac_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pacientes` VALUES (1,'2paciente1','1paciente123'),(2,'2paciente2','2paciente123'),(3,'2paciente3','3paciente123'),(4,'2paciente4','4paciente123'),(5,'2paciente5','5paciente123');
...
CREATE TABLE `personas` (
  `Per_id` int NOT NULL,
  `Per_nombrecompleto` varchar(45) DEFAULT NULL,
  `Per_rut` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `personas` VALUES (1,'Matias Gonzales Perez','18778932-6'),(2,'Carlos Jarpa Lopez','15774232-1'),(3,'Fernando Marquez Letelier','14776972-7'),(4,'Nicolas Ferrada Zabaleta','16443567-8'),(5,'Tomas Ovalle Elgueta','14112345-8'),(6,'Andrea Pizarro Galvez','19887654-6'),(7,'Carla Aedo Vielma','15332882-5'),(8,'Mateo Lara Villa','16112325-5'),(9,'Camilo Zambrano Lara','18332946-2'),(10,'Patricio Galaz Andrade','19833176-1');
...
CREATE TABLE `valores` (
  ...
  `Valor_especialista` varchar(45) DEFAULT NULL,
  `Valor_precio` int DEFAULT NULL,
...
INSERT INTO `valores` VALUES (1,'Traumatologia',20000),(2,'Oftalmologia',25000),(3,'Cardiologia',22000),(4,'Oncologia',28000),(5,'Neurologia',26000);
...
-- Dump completed on 2022-12-03 20:24:07
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-11-16 23:21:09',NULL),('diagnostics.include_raw','OFF','2022-11-16 23:21:09',NULL),('ps_thread_trx_info.max_length','65535','2022-11-16 23:21:09',NULL),('statement_performance_analyzer.limit','100','2022-11-16 23:21:09',NULL),('statement_performance_analyzer.view',NULL,'2022-11-16 23:21:09',NULL),('statement_truncate_len','64','2022-11-16 23:21:09',NULL);
